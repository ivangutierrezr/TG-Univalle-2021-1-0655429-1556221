...
#Función que se encarga de reproducir el universo. En este caso reproduce los individuos de mejor fitness organizados en orden ascendente de un universo con los de mejor fitness de otro universo organizados en orden ascendente. Además, como en esta estrategia se reemplaza a uno de los padres, se evalúa de una vez cual padre tiene mejor fitness y se devuelve la posición del padre a reemplazar
...
plt.ylabel('Density')
plt.xlabel('Edges')
plt.title('Degree distribution Ruleta 22')
figHist = plt.gcf()

figHist.savefig('DistribucionGradoRuleta22.png')

plt.clf()

template = """Información de la red estrategia Ruleta 22
...
nx.write_gexf(G, "infoCEMRuleta22.gexf", version="1.2draft")
...
with open('infoCEMRuleta22Fitnesses.csv', 'w', encoding='UTF8', newline='') as f:
    writer = csv.DictWriter(f, fieldnames=fieldnames)
    writer.writeheader()
    writer.writerows(infoFitnesses)

# Creación de informe completo de Tiempos
with open('infoCEMRuleta22Times.csv', 'w', encoding='UTF8', newline='') as f:
    writer = csv.DictWriter(f, fieldnames=fieldnames)
    writer.writeheader()
    writer.writerows(infoTimes)

# Creación de informe completo de Resumen
with open('ResumenRuleta22.csv', 'w', encoding='UTF8', newline='') as f:
...
ax.set_title("Estrategia Ruleta 22")
...
# plt.show()
plt.savefig("GraficoRuleta22.png", dpi=1600)