...
plt.ylabel('Density')
plt.xlabel('Edges')
plt.title('Degree distribution Elite 11')
figHist = plt.gcf()

figHist.savefig('DistribucionGradoElite11.png')

plt.clf()

template = """Información de la red estrategia Elite 11
...
nx.write_gexf(G, "infoCEMElite11.gexf", version="1.2draft")
...
with open('infoCEMElite11Fitnesses.csv', 'w', encoding='UTF8', newline='') as f:
    writer = csv.DictWriter(f, fieldnames=fieldnames)
    writer.writeheader()
    writer.writerows(infoFitnesses)

# Creación de informe completo de Tiempos
with open('infoCEMElite11Times.csv', 'w', encoding='UTF8', newline='') as f:
    writer = csv.DictWriter(f, fieldnames=fieldnames)
    writer.writeheader()
    writer.writerows(infoTimes)

# Creación de informe completo de Resumen
with open('ResumenElite11.csv', 'w', encoding='UTF8', newline='') as f:
...
ax.set_title("Estrategia Elite 11")
...
# plt.show()
plt.savefig("GraficoElite11.png", dpi=1600)