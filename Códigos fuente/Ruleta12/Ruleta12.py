...
plt.ylabel('Density')
plt.xlabel('Edges')
plt.title('Degree distribution Ruleta 12')
figHist = plt.gcf()

figHist.savefig('DistribucionGradoRuleta12.png')

plt.clf()

template = """Información de la red estrategia Ruleta 12
...
nx.write_gexf(G, "infoCEMRuleta12.gexf", version="1.2draft")
...
with open('infoCEMRuleta12Fitnesses.csv', 'w', encoding='UTF8', newline='') as f:
    writer = csv.DictWriter(f, fieldnames=fieldnames)
    writer.writeheader()
    writer.writerows(infoFitnesses)

# Creación de informe completo de Tiempos
with open('infoCEMRuleta12Times.csv', 'w', encoding='UTF8', newline='') as f:
    writer = csv.DictWriter(f, fieldnames=fieldnames)
    writer.writeheader()
    writer.writerows(infoTimes)

# Creación de informe completo de Resumen
with open('ResumenRuleta12.csv', 'w', encoding='UTF8', newline='') as f:
...
ax.set_title("Estrategia Ruleta 12")
...
# plt.show()
plt.savefig("GraficoRuleta12.png", dpi=1600)