...
plt.ylabel('Density')
plt.xlabel('Edges')
plt.title('Degree distribution Ruleta 21')
figHist = plt.gcf()

figHist.savefig('DistribucionGradoRuleta21.png')

plt.clf()

template = """Información de la red estrategia Ruleta 21
...
nx.write_gexf(G, "infoCEMRuleta21.gexf", version="1.2draft")
...
with open('infoCEMRuleta21Fitnesses.csv', 'w', encoding='UTF8', newline='') as f:
    writer = csv.DictWriter(f, fieldnames=fieldnames)
    writer.writeheader()
    writer.writerows(infoFitnesses)

# Creación de informe completo de Tiempos
with open('infoCEMRuleta21Times.csv', 'w', encoding='UTF8', newline='') as f:
    writer = csv.DictWriter(f, fieldnames=fieldnames)
    writer.writeheader()
    writer.writerows(infoTimes)

# Creación de informe completo de Resumen
with open('ResumenRuleta21.csv', 'w', encoding='UTF8', newline='') as f:
...
ax.set_title("Estrategia Ruleta 21")
...
# plt.show()
plt.savefig("GraficoRuleta21.png", dpi=1600)