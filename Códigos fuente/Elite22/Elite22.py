...
plt.ylabel('Density')
plt.xlabel('Edges')
plt.title('Degree distribution Elite 22')
figHist = plt.gcf()

figHist.savefig('DistribucionGradoElite22.png')

plt.clf()

template = """Información de la red estrategia Elite 22
...
nx.write_gexf(G, "infoCEMElite22.gexf", version="1.2draft")
...
with open('infoCEMElite22Fitnesses.csv', 'w', encoding='UTF8', newline='') as f:
    writer = csv.DictWriter(f, fieldnames=fieldnames)
    writer.writeheader()
    writer.writerows(infoFitnesses)

# Creación de informe completo de Tiempos
with open('infoCEMElite22Times.csv', 'w', encoding='UTF8', newline='') as f:
    writer = csv.DictWriter(f, fieldnames=fieldnames)
    writer.writeheader()
    writer.writerows(infoTimes)

# Creación de informe completo de Resumen
with open('ResumenElite22.csv', 'w', encoding='UTF8', newline='') as f:
...
ax.set_title("Estrategia Elite 22")
...
# plt.show()
plt.savefig("GraficoElite22.png", dpi=1600)